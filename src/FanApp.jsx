            ...
            <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 32 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16 }}>
                  <div style={{ width: 64, height: 64, borderRadius: '50%', background: '#161616', border: `2px solid ${accent}`, overflow: 'hidden', flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {fanEvents.map(rsvp => {
                ...
                return (
                  <div key={rsvp.id} style={{ background: '#0e0e0e', border: `1px solid ${accent}22`, borderRadius: 12, padding: '20px 24px' }}>
                    ...
                    <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                      {event.stream_url && (
                        <a href={event.stream_url} target="_blank" rel="noreferrer" style={{ background: accent, color: '#080808', borderRadius: 6, padding: '8px 18px', fontFamily: "'DM Mono', monospace", fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', textDecoration: 'none' }}>
                          JOIN STREAM →
                        </a>
                      )}
                      <button
