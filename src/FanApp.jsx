...
export default function FanApp({ session, profile, onSignOut }) {
  ...
  return (
    <div style={pageStyle}>
      ...
      {/* Ambient glow */}
      <div style={{
        position: 'fixed', top: 0, left: 0, width: 700, height: 500,
        background: `radial-gradient(ellipse at 20% 0%, ${ACCENT}08 0%, transparent 60%)`,
      ...
      <nav style={{
        ...
        background: BG + 'ee', backdropFilter: 'blur(20px)',
        zIndex: 100, position: 'sticky',
      }}>
          ...
          {!selected && (
            <div style={{ padding: '44px 28px', maxWidth: 960, margin: '0 auto' }}>
              <div style={{ marginBottom: 36 }}>
                <div style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 36, color: TEXT1, lineHeight: 1.15, marginBottom: 6 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(290px, 1fr))', gap: 20 }}>
                  {creators.map(c => (
                    <div key={c.id} onClick={() => selectCreator(c)}
                      style={{
                        background: `linear-gradient(145deg, ${BG2} 0%, ${BG3} 100%)`,
                        border: `1px solid ${BORDER}`,
                    ...
                    >
                      {/* Avatar — single, no duplicate */}
                      <div style={{
                        width: 52, height: 52, borderRadius: '50%',
                        background: BG3, border: `2px solid ${ACCENT}55`,
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                        fontFamily: "'DM Serif Display', Georgia, serif",
                        fontSize: 17, color: ACCENT, marginBottom: 18,
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingTop: 14, borderTop: `1px solid ${BORDER2}` }}>
                        <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 15, color: ACCENT, fontWeight: 700 }}>${c.monthly_price}<span style={{ fontSize: 10, color: TEXT3, fontWeight: 400 }}>/mo</span></div>
            ...
            <div style={{ maxWidth: 820, margin: '0 auto', padding: '36px 28px' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
                  ...
                  <div>
                    <div style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 26, color: TEXT1, marginBottom: 4, lineHeight: 1.2 }}>{selected.profiles?.display_name}</div>
                  ...
                  <div key={post.id} style={{
                    ...
                    <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <div style={{ fontSize: 14, color: canView ? TEXT1 : TEXT3, marginBottom: 5, lineHeight: 1.3 }}>{post.title}</div>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    {creatorEvents.map(event => (
                      <div key={event.id} style={{
                        ...
                        boxShadow: `0 2px 20px ${ACCENT}06`,
                      }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
                          ...
                          <span style={{
                            ...
                            border: `1px solid ${ACCENT}40`, borderRadius: 5,
                            fontSize: 9, fontWeight: 700, padding: '3px 9px',
                            letterSpacing: '0.14em', fontFamily: "'DM Mono', monospace", flexShrink: 0,
                          }}>
                        ...
                        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                          {subscribed ? (
                            <button onClick={() => handleRsvp(event.id)} style={{
                              background: eventRsvps[event.id] ? BORDER : ACCENT,
                              ...
                              boxShadow: eventRsvps[event.id] ? 'none' : `0 4px 16px ${ACCENT}30`,
                            }}>
              ...
              {fanEvents.map(rsvp => {
                ...
                return (
                  <div key={rsvp.id} style={{
                    ...
                    boxShadow: `0 2px 24px ${ACCENT}08`,
                  }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 10 }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-end' }}>
                        ...
                        <span style={{
                          background: '#6dbf8a18', color: '#6dbf8a',
                          border: '1px solid #6dbf8a40', borderRadius: 5,
                          fontSize: 9, fontWeight: 700, padding: '3px 9px',
                          letterSpacing: '0.14em', fontFamily: "'DM Mono', monospace"
                        }}>✓ RSVP'D</span>
                      </div>
